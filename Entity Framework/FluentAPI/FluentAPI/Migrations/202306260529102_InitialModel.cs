namespace FluentAPI.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        TadId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.CourseId, t.TadId })
                .ForeignKey("dbo.Courses", t => t.CourseId, cascadeDelete: true)
                .ForeignKey("dbo.Tags", t => t.TadId, cascadeDelete: true)
                .Index(t => t.CourseId)
                .Index(t => t.TadId);
        ...
        {
            DropForeignKey("dbo.CourseTags", "TadId", "dbo.Tags");
            ...
            DropIndex("dbo.CourseTags", new[] { "TadId" });
